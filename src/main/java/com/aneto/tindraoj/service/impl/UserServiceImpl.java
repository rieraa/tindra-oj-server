...
import com.aneto.tindraoj.mapper.UserMapper;
import com.aneto.tindraoj.model.dto.user.UserQueryRequest;
import com.aneto.tindraoj.model.entity.User;
import com.aneto.tindraoj.model.enums.UserRoleEnum;
import com.aneto.tindraoj.model.vo.LoginUserVO;
...
import static com.aneto.tindraoj.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public LoginUserVO userLoginByMpOpen(WxOAuth2UserInfo wxOAuth2UserInfo, HttpServletRequest request) {
        ...
        synchronized (unionId.intern()) {
            ...
            // 被封号，禁止登录
            if (user != null && UserRoleEnum.BAN.getCode().equals(user.getUserRole())) {
