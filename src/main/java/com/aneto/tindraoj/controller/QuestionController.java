...
import com.aneto.tindraoj.common.DeleteRequest;
...
import com.aneto.tindraoj.model.dto.question.QuestionAddRequest;
import com.aneto.tindraoj.model.dto.question.QuestionEditRequest;
import com.aneto.tindraoj.model.dto.question.QuestionQueryRequest;
import com.aneto.tindraoj.model.dto.question.QuestionUpdateRequest;
...
public class QuestionController {
    ...
    public BaseResponse<Boolean> deleteQuestion(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 仅本人或管理员可删除
        if (!oldQuestion.getCreatorId().equals(user.getId()) && !userService.isAdmin(request)) {
    ...
    public BaseResponse<Question> getQuestionById(long id, HttpServletRequest request) {
        ...
        User loginUser = userService.getLoginUser(request);
        // 不是本人或管理员，不能直接获取所有信息
        if (!question.getCreatorId().equals(loginUser.getId()) && !userService.isAdmin(loginUser)) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR);
        }
    ...
    public BaseResponse<Boolean> editQuestion(@RequestBody QuestionEditRequest questionEditRequest, HttpServletRequest request) {
        ...
        ThrowUtils.throwIf(oldQuestion == null, ErrorCode.NOT_FOUND_ERROR);
        // 仅本人或管理员可编辑
        if (!oldQuestion.getCreatorId().equals(loginUser.getId()) && !userService.isAdmin(loginUser)) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR);
        }
        boolean result = questionService.updateById(question);
        return ResultUtils.success(result);
