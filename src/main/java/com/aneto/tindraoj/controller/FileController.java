...
import com.aneto.tindraoj.constant.FileConstant;
import com.aneto.tindraoj.exception.BusinessException;
import com.aneto.tindraoj.manager.CosManager;
import com.aneto.tindraoj.model.dto.file.UploadFileRequest;
import com.aneto.tindraoj.model.entity.User;
import com.aneto.tindraoj.model.enums.FileUploadBizEnum;
...
public class FileController {
    ...
    public BaseResponse<String> uploadFile(@RequestPart("file") MultipartFile multipartFile,
        ...
        String filepath = String.format("/%s/%s/%s", fileUploadBizEnum.getCode(), loginUser.getId(), filename);
        File file = null;
        try {
            // 上传文件
